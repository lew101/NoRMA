...
# Completes a calibration loop and then outputs raw forward and left values
import board
import busio
...
MAX = 2047
FORWARD_CENTER = 1162 # Use 1233 for joystick voltage and 1162
LEFT_CENTER = 1173 # Use 1232 for joystick voltage and 1173
DEVIATION_ERROR = 10
